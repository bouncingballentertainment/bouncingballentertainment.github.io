...
const TRANSLATIONS = {
  en: {
    ...
    mid_cta_quote:'"With Volum I walk in ready, execute, and can actually see my progression improving."<cite> · Daniela Rojas</cite>',
  ...
  es: {
    ...
    mid_cta_quote:'"Con Volum llego lista, ejecuto y puedo ver claramente cómo progreso."<cite> · Daniela Rojas</cite>',
  ...
  pt: {
    ...
    mid_cta_quote:'"Com o Volum chego pronta, executo e consigo ver claramente minha progressão."<cite> · Daniela Rojas</cite>',
